...
Il suffit que l'opérateur de covoiturage soit partenaire du registre de preuve de covoiturage. L'opérateur peut ensuite mettre en place un dispositif de téléchargement des attestations basé sur le service mis à disposition par le registre de preuve de covoiturage. \(Cf. la rubrique [implémenter le système d'attestations pour les opérateurs](../operateurs/attestations-de-covoiturage.md)\)
