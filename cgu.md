---
description: CGU en date du 20/03/2019. Les retours sont les bienvenus.
---
...
Le covoiturage est défini par le Code des transports \(article L. 3132-1\) comme l'utilisation en  
commun d'un véhicule terrestre à moteur par un conducteur et un ou plusieurs passagers,  
effectuée à titre non onéreux, excepté le partage des frais, dans le cadre d'un déplacement que  
...
Le responsable du traitement fournit les moyens nécessaires et raisonnables pour assurer un accès continu au Service, sans contrepartie financière. L’indisponibilité du Service ne saurait ouvrir droit à aucune compensation quelle qu’en soit sa nature.  
  
Le responsable du traitement se réserve la liberté de faire évoluer, de modifier ou de suspendre, sans préavis, la plateforme pour des raisons de maintenance ou pour tout autre motif jugé nécessaire. Néanmoins, il fait tout ce qui est en son pouvoir pour informer les partenaires des interruptions de service.
...
Au delà de ces statistiques, le responsable du traitement diffuse en [Licence Ouverte](https://www.etalab.gouv.fr/licence-ouverte-open-licence) des données statistiques et historique sur l’activité du Service, sans ré-identification possible des covoitureurs et opérateurs de covoiturage.
